        ...
        <form onSubmit={submit} className="space-y-4">
          <label className="block text-sm font-bold">
            ...
            <input autoComplete="username" value={username} onChange={(event) => setUsername(event.target.value)}
              className="mt-1.5 w-full rounded-xl border border-[#c2c6d2] dark:border-slate-700 bg-[#f7f9ff] dark:bg-slate-800 px-4 py-3 font-normal focus:outline-none focus:ring-2 focus:ring-[#004782]"
              placeholder="请输入用户名" />
          </label>
          <label className="block text-sm font-bold">
            密码
