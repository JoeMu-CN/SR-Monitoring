      ...
      {risk && (
        ...
        <div className="sticky top-0 z-10 flex items-center justify-between border-b border-slate-200/80 bg-white/90 px-6 py-4 backdrop-blur-md dark:border-slate-800 dark:bg-slate-950/90">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              disabled
              className="px-3.5 py-1.5 rounded-lg text-[13px] font-bold flex items-center gap-1.5 bg-[#004782] text-white opacity-80 cursor-not-allowed"
              title="监控状态请在供应商台账中管理"
            >
          ...
          <div className="grid grid-cols-1 items-center gap-6 rounded-2xl border border-slate-200/80 bg-white/80 p-5 shadow-sm backdrop-blur-md dark:border-slate-800 dark:bg-slate-950/80 md:grid-cols-12">
            <div className="md:col-span-8 space-y-3">
              ...
              <p className="text-[13px] text-slate-600 dark:text-slate-400">
                系统基于当前风险信号、供应商匹配证据与固定评分规则得出 {risk.level} 评级。
              </p>
              ...
              <div className="pt-2">
                <button
                  onClick={() => {
                    onClose();
                    onAskAssistant(`请分析【${risk.companyName}】当前风险的事件摘要、匹配证据与评分明细。`);
                  }}
          ...
          <div className="space-y-4 rounded-2xl border border-slate-200/80 bg-white/80 p-5 shadow-sm backdrop-blur-md dark:border-slate-800 dark:bg-slate-950/80">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3 relative">
              <div className="bg-[#f7f9ff] dark:bg-slate-900 border border-[#c2c6d2] dark:border-slate-800 rounded-xl p-3.5 text-center space-y-1">
                ...
                <div className="text-[11px] text-slate-500">{risk.source ?? '来源未披露'}</div>
              </div>
              ...
              <div className="bg-[#f7f9ff] dark:bg-slate-900 border border-[#c2c6d2] dark:border-slate-800 rounded-xl p-3.5 text-center space-y-1">
                ...
                <div className="text-[11px] text-slate-500">{risk.eventCategory ?? risk.riskType}</div>
              </div>
              ...
              <div className="bg-[#f7f9ff] dark:bg-slate-900 border border-[#c2c6d2] dark:border-slate-800 rounded-xl p-3.5 text-center space-y-1">
                ...
                <div className="text-[11px] text-slate-500">{risk.matchReasons?.entityMatch ?? risk.matchType ?? '匹配证据未披露'}</div>
              </div>
                ...
                <div className="space-y-2 text-[12px]">
                  <div>
                    ...
                    <span className="ml-2 bg-blue-50 text-[#004782] px-2 py-0.5 rounded font-bold">
                      {risk.eventCategory ?? risk.riskType}
                    </span>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <div className="mt-1 font-medium text-slate-700 dark:text-slate-300">
                      {risk.impactScope ?? '当前信号未提供结构化影响范围'}
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="lg:col-span-6 space-y-6">
              ...
              <div className="bg-white dark:bg-slate-950 border border-[#c2c6d2] dark:border-slate-800 rounded-xl p-4 space-y-3">
                <div className="flex justify-between items-center font-bold text-[14px]">
                  ...
                  <span className="text-xs text-slate-400 font-mono">共 {risk.originalSignals?.length ?? 0} 条</span>
                </div>
