...
import { ChevronRight, ShieldCheck, RefreshCw, Info, Radio, BarChart3, LayoutDashboard } from 'lucide-react';
    ...
    <div className="space-y-5 pb-20 lg:pb-8">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center bg-slate-200/80 dark:bg-slate-800/90 p-1 rounded-xl border border-black/5 dark:border-white/5 text-xs font-semibold">
            <button
      ...
      {/* Content conditional on activeSubTab */}
      {activeSubTab === 'charts' ? (
        <DataVisualizationDashboard isDarkMode={isDarkMode} />
      ) : (
        <>
          ...
          {/* Embedded Data Visualization Dashboard Section */}
